# SOC-L1
A curated collection of notes, resources, tools, and hands-on guides for aspiring SOC L1 analysts. Covers cybersecurity fundamentals, SIEM basics, log analysis, alert triage, incident response, and interview preparation to help beginners get job-ready.
# 🛡️ SOC Level 1 Preparation Repository

A structured, beginner-friendly repository designed to help aspiring **Security Operations Center (SOC) Level 1 Analysts** build strong fundamentals and practical skills required for entry-level SOC roles. This repo focuses on both **theory and hands-on understanding** of real SOC workflows.
